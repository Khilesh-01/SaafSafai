...
export default function RepresentativeFinder() {
  ...
  const OfficialCard = ({ name, details, party, isMain = false }) => (
    <div className={`p-4 rounded-xl border transition-all duration-200 hover:shadow-md ${isMain
      ...
      <div className="flex items-center gap-3">
        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isMain ? 'bg-green-100 dark:bg-green-800' : 'bg-gray-200 dark:bg-gray-600'
          }`}>
          ...
          <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-800 rounded-2xl p-6 text-center">
              ...
              <p className="text-green-600 dark:text-green-400 text-sm mt-2">
                Data updated regularly • Part of the saafsafai platform
              </p>
            </div>
          </div>
        )}
