  ...
  const terms = [
    {
      ...
      content: 'You agree to use saafsafai for lawful purposes only and not to misuse or interfere with the platform\'s functionality. This includes respecting community guidelines and reporting issues in good faith.',
    ...
    },
    {
      ...
      content: 'We may revise these terms periodically to reflect changes in our services or legal requirements. Continued use of saafsafai constitutes your acceptance of any changes.',
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <p className="max-w-3xl mx-auto text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed mb-10">
            These Terms of Service govern your use of <span className="font-bold bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">saafsafai</span>.
