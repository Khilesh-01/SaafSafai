...
const testimonials = [
  {
    ...
    message:
      "saafsafai helped me report a huge pothole near my street. The issue was resolved in 3 days!",
    rating: 5
  },
  {
    name: "Meera Sharma",
    ...
    message:
      "I love how simple and fast saafsafai is. Clean streets and working streetlights again!",
    rating: 5
  },
  {
    name: "Ravi Kumar",
  ...
  },
  {
    ...
    message:
      "Being able to track my report's status makes all the difference. Fantastic work saafsafai!",
    rating: 5
  },
  {
    name: "Sanjay Singh",
  ...
  },
  {
    ...
    message:
      "Makes community participation simple and effective. Love saafsafai!",
    rating: 5
  },
];
      ...
      <div className="relative container mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Real stories from community members who are making a difference with saafsafai
          </p>
        </div>
        ...
        <div className="flex justify-center mt-8 gap-2">
          {testimonials.map((_, index) => (
            <button
              key={index}
              className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentCenter
