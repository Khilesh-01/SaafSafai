...
function ServerError() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Helmet>
        <title>Server Error | saafsafai</title>
        <meta name="description" content="We're experiencing technical difficulties. Our team is working to resolve the issue. Please try again or return to saafsafai homepage." />
        ...
        <div className="container py-6 px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold">saafsafai</span>
            </div>
            <p className="text-sm text-muted-foreground text-center">
              © {new Date().getFullYear()} saafsafai. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
